defmodule Mix.Tasks.Codeqa.SampleReport do
  ...
  @switches [category: :string, verbose: :boolean, output: :string, report: :string, apply_scalars: :boolean, file: :string, top: :integer]
  ...
  defp print_file_scores(path, opts) do
    ...
    files =
      cond do
        File.dir?(expanded) ->
          CodeQA.Collector.collect_files(expanded)
