defmodule CodeQA.HealthReport.GraderTest do
  ...
  describe "grade_cosine_categories/3" do
    # Build a minimal aggregate that the SampleRunner can process.
    # We use the real codeqa-action repo's own analysis output shape.
    # The easiest approach: use the actual codebase aggregate so we get
    # real data, then assert structure and types rather than exact values.
    setup do
      # Collect and analyze the project itself to produce a real aggregate.
