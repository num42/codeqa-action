...
namespace Payments
{
    public class PaymentGateway
    {
        ...
        // Missing Async suffix — callers cannot tell this returns a Task without inspecting the signature
        public async Task<ChargeResult> Charge(PaymentRequest request)
        {
        ...
        // Missing Async suffix — looks like a synchronous method
        public async Task<RefundResult> Refund(string chargeId, decimal amount)
        {
        ...
        public async Task<PaymentMethod> GetSavedPaymentMethod(int customerId)
        {
        ...
        // Missing Async suffix — hides the asynchronous nature from the caller
        public async Task<bool> ValidateCard(CardDetails card)
        {
