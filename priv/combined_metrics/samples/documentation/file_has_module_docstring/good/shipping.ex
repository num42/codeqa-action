defmodule MyApp.Shipping do
  @moduledoc """
  Context module for shipment lifecycle management.

  Handles creating and tracking shipments tied to orders, recording
  tracking events, and estimating delivery dates based on the selected
  shipping service and destination zone.

  All public functions in this module are the sole entry point for
  shipment-related operations. Internal schema modules such as
  `MyApp.Shipping.Shipment` and `MyApp.Shipping.TrackingEvent` should
  not be accessed directly from outside this context.
  """
